(function() {
    ...
    */
    function calculator(operador) {
        isOperatorValid(operador) === false ? false: function(n1, n2) {
    ...
    */
    if( sum ) { // sum possui valor bollean " True ", por isso pode estar sozinho, logo, se sum for true, então ...
        n1 = 10;
        n2 = 12;
    ...
    */
    ...
    if( subtraction ) { // subtraction possui valor bollean " True ", por isso pode estar sozinho, logo, se subtraction for true, então ...
        n1 = 8;
        n2 = 11;
    ...
    if( multiplication ) { // multiplication possui valor bollean " True ", por isso pode estar sozinho, logo, se multiplication for true, então ...
        n1 = 80;
        n2 = 5;
    ...
    if( division ) { // division possui valor bollean " True ", por isso pode estar sozinho, logo, se division for true, então ...
        n1 = 150;
        n2 = 3;
    ...
    if( mod ) { // mod possui valor bollean " True ", por isso pode estar sozinho, logo, se mod for true, então ...
        n1 = 150;
        n2 = 11;
    ...
    */
   operationSignal = 'lili';
   var invalid = calculator( operationSignal );
   if( invalid ) { // invalid possui valor bollean " True ", por isso pode estar sozinho, logo, se invalid for true, então ...
       n1 = 80;
       n2 = 5;
